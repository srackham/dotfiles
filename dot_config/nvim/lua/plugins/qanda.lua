return {
  ...
  config = function()
    ...
    vim.keymap.set({ "n", "v" }, "ac", "<Cmd>Qanda /chat_window<CR>", { desc = "Qanda.nvim open Chat window" })
    ...
    vim.keymap.set({ "n", "v" }, "an", "<Cmd>Qanda /new_prompt<CR>", { desc = "Qanda.nvim open new prompt" })
    vim.keymap.set({ "n", "v" }, "ap", "<Cmd>Qanda /prompt_window<CR>", { desc = "Qanda.nvim open Prompt window" })
    vim.keymap.set({ "n", "v" }, "ar", "<Cmd>Qanda /recent_models<CR>", { desc = "Qanda.nvim recent model selection" })
    vim.keymap.set({ "n", "v" }, "at", "<Cmd>Qanda /prompt_template_picker<CR>", { desc = "Qanda.nvim open prompts template picker" })
    vim.keymap.set({ "n", "v" }, "aT", "<Cmd>Qanda /system_template_picker<CR>", { desc = "Qanda.nvim open System template picker" })
    vim.keymap.set({ "n", "v" }, "au", "<Cmd>Qanda /turn_picker<CR>", { desc = "Qanda.nvim open turn picker" })
